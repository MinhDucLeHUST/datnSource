...
class AppColor {
  ...
  static const Color safety = Color(0xff66cc66);
  ...
  static const Color greyBold = Color(0xff30302f);
  static const Color lightGrey1 = Color(0xffBEBEBE);
  static const Color lightGrey2 = Color(0xffB0B0B0);
  static const Color keyboardGrey = Color(0xffD2D5DB);
  ...
  static const Color warningYellow = Color(0xffE6CC00);
}
